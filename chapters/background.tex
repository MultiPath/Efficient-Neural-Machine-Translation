...
For instance, such approaches replace RNN layers in the decoder with parallelzable modules like  masked convolution layers~\cite{kalchbrenner2016neural, gehring2017convolutional} or self-attention~\cite{vaswani2017attention}. %that provide the causal structure required by the autoregressive factorization.

\paragraph{The Transformer Model}
We specially introduce the Transformer model proposed in \newcite{vaswani2017attention} as an inportant example. 
